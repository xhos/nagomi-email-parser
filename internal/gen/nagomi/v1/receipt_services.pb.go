...
const file_nagomi_v1_receipt_services_proto_rawDesc = "" +
	...
	"\x11RetryParseReceipt\x12#.nagomi.v1.RetryParseReceiptRequest\x1a$.nagomi.v1.RetryParseReceiptResponseB\x9f\x01\n" +
	"\rcom.nagomi.v1B\x14ReceiptServicesProtoP\x01Z3nagomi-email-parser/internal/gen/nagomi/v1;nagomiv1\xa2\x02\x03NXX\xaa\x02\tNagomi.V1\xca\x02\tNagomi\\V1\xe2\x02\x15Nagomi\\V1\\GPBMetadata\xea\x02\n" +
